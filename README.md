...
*   **RAGチャット**: アップロードされたドキュメントに基づいた質問応答。
...
*   **RAGチャット機能**:
    ...
    *   LangChainを利用したRAGパイプライン（検索→プロンプト拡張→LLM応答生成）。
...
計画中の機能改善や新機能。 (今後記述予定)
*   フロントエンドでのドキュメント管理UIの充実 (アップロード、一覧表示、削除)
...
本プロジェクトは MITライセンス の下で公開される予定です。(最終確認後に正式に記載)
